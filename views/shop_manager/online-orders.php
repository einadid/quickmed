<?php
/**
 * Shop Manager - Online Orders View
 */
...
$pageTitle = 'Online Orders - Shop Manager';
$user = getCurrentUser();
$shopId = $user['shop_id'];
...
$whereClause = "p.shop_id = $shopId AND o.delivery_type = 'home'"; // Only online/home delivery orders

if ($status !== 'all') {
    $whereClause .= " AND p.status = '$status'";
}

// Get orders assigned to this shop
        ...
        <div class="grid md:grid-cols-2 gap-6">
            ...
            <?php else: ?>
                <?php while ($order = $orders->fetch_assoc()): ?>
                    <div class="card bg-white border-4 border-deep-green hover:shadow-retro-lg transition-all" data-aos="fade-up">
